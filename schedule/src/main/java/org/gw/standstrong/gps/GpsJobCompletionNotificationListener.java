...
@Component
@Slf4j
public class GpsJobCompletionNotificationListener extends JobExecutionListenerSupport {
    ...
    @Autowired
    public GpsJobCompletionNotificationListener(JdbcTemplate jdbcTemplate, ImportFileService importFileService, ProjectRepository projectRepository) {
    ...
    public void beforeJob(JobExecution jobExecution) {
        ...
        importFile.setFileType(ImportFile.FILE_TYPE_GPS);
