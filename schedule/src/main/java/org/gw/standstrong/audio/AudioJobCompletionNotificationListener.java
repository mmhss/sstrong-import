...
@Component
@Slf4j
public class AudioJobCompletionNotificationListener extends JobExecutionListenerSupport {
    ...
    @Autowired
    public AudioJobCompletionNotificationListener(JdbcTemplate jdbcTemplate, ImportFileService importFileService, ProjectRepository projectRepository) {
    ...
    public void beforeJob(JobExecution jobExecution) {
        ...
        importFile.setFileType(ImportFile.FILE_TYPE_AUDIO);
